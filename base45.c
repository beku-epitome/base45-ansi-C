...
static const unsigned char _C2I[256] = {
...
int base45_encode(unsigned char *dst, size_t *_max_dst_len, const unsigned char *src,
                  size_t src_len)
{
...
int base45_decode(unsigned char *dst, size_t *_max_dst_len, const unsigned char *src,
                  size_t src_len)
{
    size_t out_len = 0, max_dst_len;
...
#  ifdef VALIDATE
    int i;
    for (i = 0; i < 45; i++)
        assert(i == _C2I[BASE45_CHARSET[i]]);
#  endif
