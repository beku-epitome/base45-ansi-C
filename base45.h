...
/** int base45_encode(char * dstOrNull, size_t *dst_lenOrNull, const unsigned char * src, size_t
 src_len);
 ...
 This can be used in conjuction with a NULL destination to get the length of the buffer needed.
 (Though x3 is always safe).
...
int base45_encode(unsigned char *dstOrNull, size_t *dst_lenOrNull, const unsigned char *src,
                  size_t src_len);

/** int base45_decode(unsigned char * dstOrNull, size_t *dst_lenOrNull, const char * src, size_t
 src_len);
 ...
 params:
   ...
   If the encoded string is longer than *dst_lenOrNull the actual length will still be returned.
 This can also be used, in combiantion with a NULL destination, to get the size of the buffer
 needed.
...
int base45_decode(unsigned char *dstOrNull, size_t *dst_lenOrNull, const unsigned char *src,
                  size_t src_len);
#endif
